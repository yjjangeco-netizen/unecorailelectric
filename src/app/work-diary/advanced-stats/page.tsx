            ...
            {loading ? (
              ...
              <div className="space-y-6">
                ...
                {stats.map((stat, index) => (
                  <div key={index} className={`rounded-lg p-6 border shadow-md ${
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <h3 className={`text-lg font-semibold ${
                        stat.category === '초과근무 현황' ? 'text-red-800' : 'text-slate-800'
                      }`}>
                        {stat.category}
                      </h3>
                      <div className={`text-3xl font-bold ${
                        stat.category === '초과근무 현황' ? 'text-red-600' : 'text-blue-600'
                      }`}>
